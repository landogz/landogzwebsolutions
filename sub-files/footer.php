    ...
    <footer class="page-footer dark-color-footer" id="page-footer">
      ...
      <div class="container">
        <div class="row footer-cols">
          <div class="col-12 col-md-8 col-lg-4  footer-col "><img class="img-fluid footer-logo" loading="lazy" src="assets/images/logo/landogz.png" alt="logo"/>
          ...
          <div class="col-12     col-lg-4 footer-col ">
            ...
            <div class="footer-col-content-wrapper">       
              <div class="contact-info-card"><i class="bi bi-envelope icon"></i><a class="text-lowercase  info" href="mailto:example@support.com">landogzwebsolutions@gmail.com</a></div>
              <div class="contact-info-card"><i class="bi bi-geo-alt icon"></i><span class="text-lowercase  info">Purok 4 Tampo, Botolan, Zambales</span></div>
              <div class="contact-info-card"><i class="bi bi-phone icon"></i><a class="info" href="tel:+20123456789">+639387077940  </a></div>
            ...
            <div class="col-12 col-md-6 d-flex justify-content-start">
              <p class="creadits">
                ...
                Created by:
                           ...
                           <a class="link" href="#0">Landogz Web Solutions</a>
              </p>
            </div>
...
<!-- Mirrored from amincodes.com/html/flex-it/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Aug 2023 18:58:06 GMT -->
</html>