...
<?php include 'sub-files/header.php';?>
            ...
            <div class="hero-text-area   ">
              <div class="row">
                ...
                <div class="col-10       ">
                  ...
                  Empowering businesses with innovative technologies, tailored strategies, and reliable support to drive success and growth.
                  </p>
                </div>
                <div class="col-12   ">
                  <div class="cta-links-area "><a class=" btn-outline cta-link cta-link-primary " href="contact-us">contact us now</a>
      ...
      <div class="container">
        <div class="sec-heading  ">
          <div class="content-area"><span class=" pre-title       wow fadeInUp " data-wow-delay=".2s">services</span>
            ...
            <p class="subtitle   wow fadeInUp " data-wow-delay=".6s">At Landogz Web Solutions, we provide cutting-edge web development and 
              IT solutions tailored to your business needs. Explore our wide range of services designed to help you succeed in the digital age.</p>
          </div>
          <div class=" cta-area   wow fadeInUp" data-wow-delay=".8s"><a class="cta-btn btn-solid" href="services">see all services <i class="bi bi-arrow-right icon "></i></a></div>
        </div>
        <div class="row gx-4 gy-4 services-row ">  
          <div class="col-12 col-md-6  col-lg-4 mx-auto ">
            ...
            <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".1s">
              ...
              <div class="service-content">
                ...
                We create responsive, secure, and high-performing websites tailored to your business goals.
                </p>
          ...
          <div class="col-12 col-md-6  col-lg-4 mx-auto ">
            ...
            <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".2s">
              ...
              <div class="service-content">
                ...
                <p class="service-text">
                Build powerful online stores with seamless payment integration and a user-friendly experience.
                </p>
              </div><a class="read-more" href="service-single.html">read more<i class="bi bi-arrow-right icon "></i></a>
            </div>
          ...
          <div class="col-12 col-md-6  col-lg-4 mx-auto  ">
            ...
            <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".3s">
              ...
              <div class="service-content">
                ...
                <p class="service-text">
                Streamline your business processes with robust API integrations and third-party solutions.
                </p>
              </div><a class="read-more" href="service-single.html">read more<i class="bi bi-arrow-right icon "></i></a>
            </div>
          ...
          <div class="col-12 col-md-6  col-lg-4 mx-auto  ">
            ...
            <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".4s">
              ...
              <div class="service-content">
                ...
                <p class="service-text">
                Build feature-rich mobile and web apps that deliver an exceptional user experience and meet your business objectives.
                </p>
              </div><a class="read-more" href="service-single.html">read more<i class="bi bi-arrow-right icon "></i></a>
            </div>
          ...
          <div class="col-12 col-md-6  col-lg-4 mx-auto  ">
            ...
            <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".5s">
              ...
              <div class="service-content">
                ...
                <p class="service-text">
                Boost your online presence with effective SEO strategies and targeted digital marketing campaigns.
                </p>
              </div><a class="read-more" href="service-single.html">read more<i class="bi bi-arrow-right icon "></i></a>
            </div>
            <!-- End 5th service box-->
          ...
          <div class="col-12 col-md-6  col-lg-4 mx-auto  ">
            ...
            <div class="box service-box  wow fadeInUp  reveal-start" data-wow-offset="0" data-wow-delay=".6s">
              ...
              <div class="service-content">
                <h3 class="service-title">Cloud Hosting & Maintenance</h3>
                <p class="service-text">
                Ensure optimal performance with reliable cloud hosting and comprehensive maintenance plans.
                </p>
              </div><a class="read-more" href="service-single.html">read more<i class="bi bi-arrow-right icon "></i></a>
            </div>
            <!-- End 6th service box-->
              ...
              <div class="text-area ">
                <div class="sec-heading  light-title ">
                  <div class="content-area"><span class=" pre-title       wow fadeInUp " data-wow-delay=".2s">about Us</span>
                    <h2 class=" title    wow fadeInUp" data-wow-delay=".4s"><span class='hollow-text'>trusted</span> by worldwide clients  since<span class='featured-text'>  2018. <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 150" preserveAspectRatio="none"><path d="M7.7,145.6C109,125,299.9,116.2,401,121.3c42.1,2.2,87.6,11.8,87.3,25.7"></path></svg></span></h2>
                  </div>
                </div>
                <p class=" about-text">Landogz Web Solutions has been delivering innovative IT and web development services to businesses worldwide. With a commitment to excellence and customer satisfaction, we empower organizations to thrive in the digital era.</p>
                    ...
                    <div class="col-9 col-xl-6">
                      <div class="info-item"><i class="flaticon-medal  info-icon"></i>
                        <div class="info-content">
                          ...
                          <p class="info-text">We are pioneers in the industry, setting the standards for innovation and quality.</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-9 col-xl-6">
                      <div class="info-item"><i class="flaticon-game-console info-icon"></i>
                        <div class="info-content">
                          ...
                          <p class="info-text">Our team is always accessible, ensuring seamless communication and collaboration.</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-9 col-xl-6">
                      <div class="info-item"><i class="flaticon-map info-icon"></i>
                        <div class="info-content">
                          ...
                          <p class="info-text">Serving clients across the globe with scalable and tailored solutions to meet diverse needs.</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-9 col-xl-6">
                      <div class="info-item"><i class="flaticon-technical-support-1  info-icon"></i>
                        <div class="info-content">
                          ...
                          <p class="info-text">Our dedicated support team is available around the clock to assist you whenever needed.</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-lg-6 d-flex align-items-center about-col pad-start  wow fadeInUp " data-wow-delay="0.6s">
              <div class="text-area ">
                ...
                <p class=" about-text">We are dedicated to providing exceptional services that empower businesses to achieve their goals. With a client-first approach, innovative solutions, and a proven track record of success, we stand out as a trusted partner for all your IT and web development needs.</p>
                <div class="info-items-list">
                  <div class="row ">
                    <div class="col-12 ">
                      <div class="info-item"><span class="info-number ">01.</span>
                        <div class="info-content">
                          ...
                          <p class="info-text">We leverage cutting-edge tools and technologies to deliver solutions that are not just up-to-date but also future-ready.</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-12 ">
                      <div class="info-item"><span class="info-number ">02.</span>
                        <div class="info-content">
                          ...
                          <p class="info-text">Every business is different, and so are our solutions. We tailor our services to meet your unique challenges and objectives.</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-12 ">
                      <div class="info-item"><span class="info-number ">03.</span>
                        <div class="info-content">
                          ...
                          <p class="info-text">Our expert team crafts data-driven strategies that ensure impactful results and sustainable growth. Let me know if you'd like further enhancements or additional points!</p>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="cta-area "><a class=" btn-solid " href="aboutus">get in touch</a></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row ">
            ...
            <div class="col-12 col-md-6 col-lg-3 stat-box ">
              <div class="stat-box-inner  " data-tilt="data-tilt"><i class="flaticon-user stat-icon"></i>
                <p class="stat-num "><span class="counter" data-from="0" data-to="100" data-speed="3000" data-refresh-interval="50"></span><span class="sign">+</span></p><span class="stat-desc">happy customers</span>
              </div>
            </div>
            <!--Info Four-->
            <div class="col-12 col-md-6 col-lg-3 stat-box ">
      ...
      <div class="container">
        <div class="sec-heading   centered ">
          <div class="content-area">
            <h2 class=" title    wow fadeInUp" data-wow-delay=".4s">trusted by over 100 clients around the world</h2>
          </div>
        </div>
    ...
    <section class="pricing mega-section  " id="pricing-1" style="display:none;">
      <div class="container">
        <div class="sec-heading  ">
                  ...
                  <div class="testmonial-card d-flex align-items-center justify-content-center">
                    <div class="testimonial-content">
                      ...
                      <div class="customer-testimonial">
                        <div class="content">
                          <p class="testimonial-text ">Working with Landogz Web Solutions has been a game-changer for our business. Their innovative approach and commitment to excellence truly set them apart. We’re thrilled with the results!</p>
                        </div>
                      </div>
                      <div class="customer-info ">
                        <div class="customer-details">
                          <p class="customer-name">David Henderson</p>
                          <p class="customer-role">CEO - UWS</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="testmonial-card d-flex align-items-center justify-content-center">
                    <div class="testimonial-content">
                      ...
                      <div class="customer-testimonial">
                        <div class="content">
                          <p class="testimonial-text ">The team at Landogz Web Solutions exceeded our expectations. Their dedication, creativity, and technical expertise brought our vision to life effortlessly. Highly recommended!</p>
                        </div>
                      </div>
                      <div class="customer-info ">
                        <div class="customer-details">
                          <p class="customer-name">Mark Lawrence Jr.</p>
                          <p class="customer-role">CEO - SportsData</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="testmonial-card d-flex align-items-center justify-content-center">
                    <div class="testimonial-content">
                      ...
                      <div class="customer-testimonial">
                        <div class="content">
                          <p class="testimonial-text ">I can confidently say that Landogz Web Solutions has streamlined our processes and significantly improved the efficiency of our systems. Their innovative approach to automation has been a game-changer for our company!</p>
                        </div>
                      </div>
                      <div class="customer-info ">
                        <div class="customer-details">
                          <p class="customer-name">Benjamin Philip</p>
                          <p class="customer-role">CEO - Teeshoppen</p>
                        </div>
                      </div>
                    </div>
                  </div>
